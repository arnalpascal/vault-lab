...
kind: Deployment
metadata:
  name: vault-deployment-cluster-node-3
  labels:
    app: vault-cluster-node-3
spec:
  ...
  template:
    ...
    spec:
      ...
      - name: vault-cluster-node-3
        ...
        env:
          ...
          - name: "SKIP_SETCAP"
            value: "true"
          - name: "VAULT_TOKEN"
            value: "$VAULT_CLUSTER_NODE_3_UNSEAL_TOKEN"
          - name: "VAULT_RAFT_NODE_ID"
            value: "raft_node_3"
          - name: "VAULT_API_ADDR"
            value: "https://vault:8330"
          - name: "VAULT_CLUSTER_ADDR"
            value: "https://vault:8331"
        ports:
          - containerPort: 8200
            protocol: TCP
            hostPort: 8330
        ...
        - mountPath: /cluster/node
          name: volume-vault-cluster-node-3
      ...
      - name: volume-vault-cluster-node-3
        hostPath: 
          path: /vagrant/cluster/vault_cluster_node_3
          type: Directory
